...
class MetadataTest(tf.test.TestCase):
  """Abstract class for integration testing concrete Metadata implementations.

  Subclasses should override metadata() to return an instance of Metadata that
  ...
  def metadata(self):
    raise NotImplementedError('metadata() was not implemented')
