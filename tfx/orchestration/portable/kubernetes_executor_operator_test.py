...
from tfx.orchestration.portable import data_types, kubernetes_executor_operator
...
class KubernetesComponentLauncherTest(tf.test.TestCase):
  ...
  def _create_launcher_context(self, component_config=None):
    ...
    operator = kubernetes_executor_operator.KubernetesExecutorOperator(_SEPC)
