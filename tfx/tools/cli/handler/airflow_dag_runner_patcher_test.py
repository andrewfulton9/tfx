...
"""Tests for tfx.tools.cli.handler.airflow_dag_runner_patcher."""
...
class AirflowDagRunnerPatcherTest(tf.test.TestCase):

  @mock.patch.object(airflow_dag_runner.AirflowDagRunner, 'run', autospec=True)
